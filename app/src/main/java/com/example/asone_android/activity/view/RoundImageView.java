...
public class RoundImageView extends AppCompatImageView {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        currRound = a.hasValue(R.styleable.RoundImageView_radiuss) ? a.getDimensionPixelSize(R.styleable.RoundImageView_radiuss, currRound) : currRound;
        a.recycle();
    }
