...
class MusicselectAdapter(context: Context, layout: Int, private val systemList: MutableList<Music>) : BaseRecyAdapter(context, layout) {
    ...
    override fun onBindViewHolder(holder: MYViewholder, position: Int) {
        ...
        select.setOnClickListener {
            select.setImageResource(R.mipmap.select_none)
            music.select = false
            EventBus.getDefault().post(EventBusMessage(Constant.E_UPDATA_SYSTEM_MUSI_SELECT,position))
        }
